...
async function main(ck, code = 'xItny5c') {
    const codes = ['xItny5c','xItny5c']
    ...
    let url2 = jfInfo['url'];
    let UA = getUA();
    let actId = url2.match(/mall\/active\/([^/]+)\/index\.html/) && url2.match(/mall\/active\/([^/]+)\/index\.html/)[1] || '22Dzqz8Cvk1Cj7BdKE46ZKSVARFE';
...
async function takeRequest(ck, UA, userName, actId, code) {
    let body = { "platform": 4, "unionActId": "31149", "actId": actId, "d": code, "unionShareId": "", "type": 1, "eid": "-1" };
