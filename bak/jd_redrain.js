...
[task_local]
#整点京豆雨
1 1 1 1 1 https://raw.githubusercontent.com/msechen/jdrain/main/jd_redrain.js, tag=整点京豆雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "1 1 1 1 1" script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_redrain.js,tag=整点京豆雨
================Surge===============
整点京豆雨 = type=cron,cronexp="1 1 1 1 1",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_redrain.js
===============小火箭==========
整点京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_redrain.js, cronexpr="1 1 1 1 1", timeout=3600, enable=true
*/
const $ = new Env('整点京豆雨');
...
!(async () => {
  ...
  for (let codeItem of codeList) {
    ...
    if (!/^RRA/.test($.activityId)) {
      console.log(`RRA: "${$.activityId}"不符合规则\n`);
      continue;
    }
    for (let i = 0; i < 5; i++) {
      if (cookiesArr[i]) {
